...
public interface VoteRepository extends BaseRepository<Vote> {
    ...
    @Query("SELECT v FROM Vote v WHERE v.restaurant.id=:restaurantId AND v.voteDate=:voteDate")
    List<Vote> findVotesByRestaurantId(@Param("restaurantId") Integer restaurantId, @Param("voteDate") LocalDate voteDate);
